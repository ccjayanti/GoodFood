...
export default function Connect() {
  ...
  return (
    <div
      ...
      className="relative text-sand mt-5 px-5 py-5 lg:h-[100vh] lg:flex lg:gap-20 lg:mt-0"
      id="connect"
    >
      <div className="lg:flex lg:flex-col lg:justify-around h-full align-middle">
        <div className="lg:flex-col align-middle">
          <div className="flex justify-between relative mt-3 uppercase text-xs lg:mt-0">
            <div>chapter</div>
            <div>004</div>
            <div>connect</div>
          </div>
          <div className="text-7xl font-regular uppercase w-full text-center py-6 lg:text-9xl">
            Connect
          </div>
        </div>
